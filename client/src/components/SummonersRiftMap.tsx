...
const MAP_POSITIONS = {
  ...
  turrets: {
    blue: {
      top: [{ x: 10, y: 42 }, { x: 12, y: 58 }, { x: 18, y: 72 }],
      mid: [{ x: 22, y: 78 }, { x: 30, y: 70 }, { x: 38, y: 62 }],
      bot: [{ x: 28, y: 88 }, { x: 42, y: 86 }, { x: 56, y: 84 }],
      nexus: [{ x: 15, y: 85 }, { x: 18, y: 82 }]
    },
    red: {
      top: [{ x: 44, y: 16 }, { x: 58, y: 14 }, { x: 72, y: 12 }],
      mid: [{ x: 62, y: 38 }, { x: 70, y: 30 }, { x: 78, y: 22 }],
      bot: [{ x: 82, y: 28 }, { x: 88, y: 42 }, { x: 90, y: 58 }],
      nexus: [{ x: 82, y: 18 }, { x: 85, y: 15 }]
    }
  }
};
